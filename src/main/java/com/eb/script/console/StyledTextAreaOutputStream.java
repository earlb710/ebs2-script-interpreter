...
/**
 * Output stream that writes to a StyleClassedTextArea with style classes.
 * Used to redirect System.out and System.err to the console.
 * 
 * @author Earl Bosch
 */
    ...
    public void flush() {
        ...
        javafx.application.Platform.runLater(() -> {
            ...
            if (styleClasses == null || styleClasses.length == 0) {
                area.setStyleClass(start, end, "info"); // default style
